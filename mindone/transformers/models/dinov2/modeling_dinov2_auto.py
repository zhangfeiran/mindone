...
class Dinov2Encoder(nn.Cell):
    ...
    def construct(self, hidden_states: ms.Tensor, output_hidden_states: bool = False) -> BaseModelOutput:
...
class Dinov2Backbone(Dinov2PreTrainedModel, BackboneMixin):
    ...
    @auto_docstring
    def construct(
        self, pixel_values: ms.Tensor, output_hidden_states: Optional[bool] = None, **kwargs
    ) -> BackboneOutput:
        r"""
        Examples:
